...
class SSDScorer(object):
    def __init__(self, model_def='/home/haoyue/codes/Pose-Transfer-master/ssd_score/deploy2.prototxt', model_weights='/home/haoyue/codes/Pose-Transfer-master/ssd_score/models/VGGNet/VOC0712/SSD_300x300/VGG_VOC0712_SSD_300x300_iter_120000.caffemodel'):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_dir", default='/home/haoyue/codes/results/market_PATN_o/test_latest/images_crop', help='Folder with images')
