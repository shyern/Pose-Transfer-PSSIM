...
target_annotation = './datasets/fasion_data/fasion-resize-annotation-test.csv'
pred_annotation = './results/results_fasion/fasion_PATN_ganppssimperl1_win7/test_latest.csv'
