...
target_annotation = '/data0/haoyue/codes/datasets/fasion_data/fasion-resize-annotation-test.csv'
pred_annotation = '/data0/haoyue/codes/results_fasion/fasion_PATN_ganppssimperl1_win7/test_latest.csv'
