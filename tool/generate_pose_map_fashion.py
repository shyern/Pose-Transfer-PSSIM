...
MISSING_VALUE = -1
# fix PATH
img_dir  = './datasets/fashion_data' #raw image path
annotations_file = './datasets/fashion_data/fasion-resize-annotation-test.csv' #pose annotation path
save_path = './datasets/fashion_data/testK' #path to store pose maps
