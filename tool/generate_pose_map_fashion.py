...
MISSING_VALUE = -1
# fix PATH
img_dir  = '/home/haoyue/codes/datasets/fashion_data' #raw image path
annotations_file = '/home/haoyue/codes/datasets/fashion_data/fasion-resize-annotation-test.csv' #pose annotation path
save_path = '/home/haoyue/codes/datasets/fashion_data/testK' #path to store pose maps
