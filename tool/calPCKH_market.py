...
# fix the PATH
target_annotation = '/data0/haoyue/codes/datasets/market_data/market-annotation-test.csv'
pred_annotation = '/data0/haoyue/codes/results/market_PATN_bpb_ssim_gan/test_latest/images_crop.csv'
