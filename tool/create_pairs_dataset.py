...
if __name__ == "__main__":
    ...
    annotations_file_train = '/data0/haoyue/codes/datasets/market_data/market-annotation-train.csv'
    pairs_file_train = '/data0/haoyue/codes/datasets/market_data/market-pairs-train-def.csv'
