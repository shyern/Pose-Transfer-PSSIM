import os
from inception_score1 import get_inception_score
...
if __name__ == "__main__":
    # fix these paths
    generated_images_dir = '/home/haoyue/codes/results/fashion_PATN/test_latest/images'
    annotations_file_test = '/home/haoyue/codes/datasets/fashion_data/fasion-resize-annotation-test.csv'
    from argparse import ArgumentParser

    parser = ArgumentParser(description="Computing ssd_score")

    parser.add_argument("--generated_images_dir",
                        default='/data0/haoyue/codes/results_fasion/fasion_PATN_ganssimperl1/test_latest/images',
                        help='Folder with images')
    parser.add_argument("--annotations_file_test",
                        default='/data0/haoyue/codes/datasets/fasion_data/fasion-resize-annotation-test.csv',
                        help='Index of image generated image '
