...
# input_folder = '/data0/haoyue/codes/results/market_PATN_ssim/test_latest/images_crop/'
# output_path = '/data0/haoyue/codes/results/market_PATN_ssim/test_latest/images_crop.csv'

# input_folder = '/data0/haoyue/codes/results/market_PATN_bp2_ssim_gan/train/'
# output_path = '/data0/haoyue/codes/datasets/market_data_s/market-annotation-train.csv'
input_folder = '/data0/haoyue/codes/results_fasion/fasion_PATN_ganppssimperl1_win7/test_660/images_crop'
output_path = '/data0/haoyue/codes/results_fasion/fasion_PATN_ganppssimperl1_win7/test_660.csv'
