...
def compute_pose2(image_dir, annotations_file, savePath):
    annotations_file = pd.read_csv(annotations_file, sep=':')
    annotations_file = annotations_file.set_index('name')
    image_size = (128, 64)
    cnt = len(annotations_file)
...
if __name__ == '__main__':
    img_dir = '/data0/haoyue/codes/datasets/market_data_s/train/'  # raw image path
    annotations_file = '/data0/haoyue/codes/datasets/market_data_s/market-annotation-train.csv'  # pose annotation path
    save_mask_path = '/data0/haoyue/codes/datasets/fasion_data/testM'  # path to store limbs maps
    # img_dir = '/data0/haoyue/codes/datasets/fashion_data/train/'  # raw image path
    # annotations_file = '/data0/haoyue/codes/datasets/fashion_data/fasion-annotation-train.csv'  # pose annotation path
    # save_mask_path = '/data0/haoyue/codes/datasets/fasion_data/testM'  # path to store limbs maps

    compute_pose(img_dir, annotations_file, save_mask_path, map_type='limbs_map', show=True)

    # img_dir = '/data0/haoyue/codes/datasets/market_data_s/train/'  # raw image path
    # annotations_file = '/data0/haoyue/codes/datasets/market_data_s/market-annotation-train.csv'  # pose annotation path
    # save_path = '/data0/haoyue/codes/datasets/market_data/trainK/'  # path to store pose maps
