...
if __name__ == "__main__":
    ...
    parser.add_argument("--generated_images_dir", default='/data0/haoyue/codes/results/market_PATN_ssim/test_latest/images', help='Folder with images')
    parser.add_argument("--annotations_file_test", default='/data0/haoyue/codes/datasets/market_data/market-annotation-test.csv',  help='Index of image generated image '
